...
floor_width = int(input("What is the width of your floor?\n> "))
floor_length = int(input("What is the length of your floor?\n> "))
tile_size = int(input("How many square units are your tiles?\n> "))
